...
Namespace XLExportExamples
    ...
    Public Module PictureActions
        ...
        Private imagesPath As String = Path.Combine(Windows.Forms.Application.StartupPath, "Images")

'#Region "Actions"
        Public InsertPictureAction As Action(Of Stream, XlDocumentFormat) = AddressOf InsertPicture

        Public StretchPictureAction As Action(Of Stream, XlDocumentFormat) = AddressOf StretchPicture

        Public FitPictureAction As Action(Of Stream, XlDocumentFormat) = AddressOf FitPicture

        Public PictureHyperlinkClickAction As Action(Of Stream, XlDocumentFormat) = AddressOf PictureHyperlinkClick

'#End Region
        Private Sub InsertPicture(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat)
...
'#End Region  ' #InsertPicture
        ...
        Private Sub StretchPicture(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat)
            ' Create an exporter instance.
            Dim exporter As IXlExporter = XlExport.CreateExporter(documentFormat)
            ' Create a new document.
            Using document As IXlDocument = exporter.CreateDocument(stream)
...
'#End Region  ' #StretchPicture
        ...
        Private Sub FitPicture(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat)
            ' Create an exporter instance.
            Dim exporter As IXlExporter = XlExport.CreateExporter(documentFormat)
            ' Create a new document.
            Using document As IXlDocument = exporter.CreateDocument(stream)
...
'#End Region  ' #FitPicture
        ...
        Private Sub PictureHyperlinkClick(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat)
