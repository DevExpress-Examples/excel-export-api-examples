...
Namespace XLExportExamples
	Public NotInheritable Class MiscellaneousActions
		...
		#Region "Actions"
		Public Shared HyperlinksAction As Action(Of Stream, XlDocumentFormat) = AddressOf Hyperlinks
		Public Shared DocumentPropertiesAction As Action(Of Stream, XlDocumentFormat) = AddressOf DocumentProperties
		Public Shared DocumentOptionsAction As Action(Of Stream, XlDocumentFormat) = AddressOf DocumentOptions
		Public Shared CsvExportOptionsAction As Action(Of Stream, XlDocumentFormat) = AddressOf CsvExportOptions
		#End Region
