...
'			#Region "ExampleNodes"
			...
			examples(7).Groups.Add(New SpreadsheetExample("Insert Hyperlinks", MiscellaneousActions.HyperlinksAction))
			examples(7).Groups.Add(New SpreadsheetExample("Document Properties", MiscellaneousActions.DocumentPropertiesAction))
			examples(7).Groups.Add(New SpreadsheetExample("Document Options and Restrictions", MiscellaneousActions.DocumentOptionsAction))
			examples(7).Groups.Add(New SpreadsheetExample("CSV Export Options", MiscellaneousActions.CsvExportOptionsAction))
