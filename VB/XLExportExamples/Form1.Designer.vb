...
'#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(XLExportExamples.Form1))
...
'#End Region
        ...
        Private btnExportToCSV As DevExpress.XtraEditors.SimpleButton

        Private btnExportToXLS As DevExpress.XtraEditors.SimpleButton

        Private btnExportToXLSX As DevExpress.XtraEditors.SimpleButton
    End Class
End Namespace
